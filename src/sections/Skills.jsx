...
export default function Skills() {
  const skills = [
    { icon: <FaCalendarCheck />, name: "Event Planning" },
    { icon: <FaUsers />, name: "Guest Management" },
    { icon: <FaMicrophoneAlt />, name: "Stage Management" },
    { icon: <MdCampaign />, name: "Event Promotion" },
    { icon: <FaHandshake />, name: "Vendor Coordination" },
    { icon: <MdSecurity />, name: "Security Management" },
    { icon: <FaRegSmile />, name: "Client Relations" },

    // ⭐ Added
    { icon: <FaStar />, name: "Celebrity Management" },

    { icon: <MdOutlineEventAvailable />, name: "On-Site Execution" },
  ];
  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        transition={{ duration: 0.5, delay: 0.1 }}
      >
        Event Planning | Premium Execution | Celebrity Handling
      </motion.p>
